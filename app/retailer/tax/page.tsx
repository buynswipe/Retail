...
function TaxContent() {
  ...
  const loadTaxSummaries = async () => {
    ...
    try {
      const { data: monthlyData } = await getTaxSummary(user.id, "retailer", "current_month")
      if (monthlyData) {
        setMonthlySummary(monthlyData)
      }

      const { data: quarterlyData } = await getTaxSummary(user.id, "retailer", "current_quarter")
      if (quarterlyData) {
        setQuarterlySummary(quarterlyData)
      }

      const { data: yearlyData } = await getTaxSummary(user.id, "retailer", "current_year")
      if (yearlyData) {
    ...
    <div className="container mx-auto max-w-4xl">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
        ...
        <TabsContent value="summary" className="space-y-6 mt-6">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-2xl font-bold">{formatCurrency(monthlySummary.total_tax_paid)}</span>
                  </div>
                  <div className="flex flex-col">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500">Tax Paid</span>
                    <span className="text-2xl font-bold">{formatCurrency(quarterlySummary.total_tax_paid)}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500">Net Tax Liability</span>
                    <div className="flex items-center">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500">Tax Paid</span>
                    <span className="text-2xl font-bold">{formatCurrency(yearlySummary.total_tax_paid)}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500">Net Tax Liability</span>
                    <div className="flex items-center">
          ...
          <Card>
            <CardHeader>
              <CardTitle>GST Filing Tips</CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <FileCheck className="mr-2 h-5 w-5 text-green-500 mt-0.5" />
                  <span>Keep all your purchase invoices for input tax credit</span>
                </li>
                <li className="flex items-start">
                  <FileCheck className="mr-2 h-5 w-5 text-green-500 mt-0.5" />
                  <span>Reconcile your purchases with supplier GSTR-1</span>
                </li>
              </ul>
            </CardContent>
          </Card>
